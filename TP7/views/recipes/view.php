        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Waktu Ditambahkan:</strong> <?php echo $resep->dibuat_pada; ?></p>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <a href="delete.php?id=<?php echo $id; ?>" class="btn btn-danger" onclick="return confirm('Yakin?')">Delete</a>
